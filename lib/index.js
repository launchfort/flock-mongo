...
class TemplateProvider {
    constructor() {
        this.migrationTypes = ['create-collection', 'alter-collection', 'other'];
    }
...
class DataAccessProvider {
    ...
    provide() {
        return __awaiter(this, void 0, void 0, function* () {
            // @ts-ignore
            const client = yield mongodb_1.MongoClient.connect(this.connectionString, { useNewUrlParser: true });
            const uri = new connection_uri_1.ConnectionUri(this.connectionString);
